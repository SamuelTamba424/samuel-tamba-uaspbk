...
<template>
  <div class="min-h-screen bg-gray-100">
    <header v-if="authStore.isAuthenticated" class="bg-white shadow-md sticky top-0 z-50">
      <nav class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="hidden md:flex items-center space-x-4">
            ...
            <RouterLink to="/profile/edit" class="text-gray-600 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">Profil Saya</RouterLink>
      ...
      <div v-if="mobileMenuOpen" class="md:hidden bg-white border-t border-gray-200 px-2 pt-2 pb-3 space-y-1 sm:px-3">
        <RouterLink to="/" @click="mobileMenuOpen = false" class="block text-gray-800 hover:bg-gray-100 px-3 py-2 rounded-md text-base font-medium">Daftar Studio</RouterLink>
        <RouterLink to="/my-bookings" @click="mobileMenuOpen = false" class="block text-gray-800 hover:bg-gray-100 px-3 py-2 rounded-md text-base font-medium">Booking Saya</RouterLink>
        <RouterLink to="/profile/edit" @click="mobileMenuOpen = false" class="block text-gray-800 hover:bg-gray-100 px-3 py-2 rounded-md text-base font-medium">Profil Saya</RouterLink>
